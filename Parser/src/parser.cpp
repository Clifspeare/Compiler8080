...
std::unique_ptr<Node> Parser::translation_unit()
{
    ...
    while (HasTokens()) {
        ...
        if(external_declaration_node->accepted) {
            self->addChild(std::move(external_declaration_node));
        }
        else {
            // HANDLE ERRORS
...
std::unique_ptr<Node> Parser::external_declaration()
{
    ...
    if (function_definition_node->accepted) {
        self->addChild(std::move(function_definition_node));
    } else {
        m_tokenIndex = saved_token_index;
        declaration_node = declaration();
        if (declaration_node->accepted) {
            self->addChild(std::move(declaration_node));
        } else {
...
std::unique_ptr<Node> Parser::function_definition()
{
    ...
    while (declaration_specifier_node->accepted) {
        ...
        self->addChild(std::move(declaration_specifier_node));
    ...
    self->addChild(std::move(declarator_node));
    ...
    self->addChild(std::move(compound_statement_node));
...
std::unique_ptr<Node> Parser::declarator()
{
    ...
    if (pointer_node->accepted) {
        self->addChild(std::move(pointer_node));
    } else {
        m_tokenIndex = saved_token_index;
    }

    std::unique_ptr<Node> direct_declarator_node = direct_declarator();
    self->addChild(std::move(direct_declarator_node));
...
std::unique_ptr<Node> Parser::primary_expression()
{
   ...
   if (nextToken.type == TokenType::ID) {
       ...
       self->addChild(std::move(identifier_node));
       ...
       self->addChild(std::move(numeric_node));
       ...
       self->addChild(std::move(string_node));
       ...
       if (!expression_node->accepted) {
           ...
           if (nextToken.type != TokenType::CLOSE_PARENS) {
               ...
               self->addChild(std::move(right_parens));
            } else {
                self->addChild(std::move(right_parens));
            }
       }
       self->addChild(std::move(left_parens));
       self->addChild(std::move(expression_node));
   } else {
       ...
       self->addChild(std::move(error_node));
   }
...
std::unique_ptr<Node> Parser::expression()
{
    ...
    if (assignment_expression_node->accepted) {
        self->addChild(std::move(assignment_expression_node));
        ...
        while (still_recursing) {
            if (tok.type == TokenType::COMMA) {
                ...
                if (inner_assignment_expression_node->accepted) { // Both the comma and assignment-expression are valid, so we can add them to the expression node and continue
                    self->addChild(std::move(comma_node));
                    self->addChild(std::move(inner_assignment_expression_node));
...
std::unique_ptr<Node> Parser::assignment_expression()
{
    ...
    if (conditional_expression_node->accepted) {
        self->addChild(std::move(conditional_expression_node));
    } else {
        ...
        self->addChild(std::move(unary_expression_node));
        self->addChild(std::move(assignment_operator_node));
        self->addChild(std::move(assignment_expression_node));
...
std::unique_ptr<Node> Parser::assignment_operator()
{
    ...
    if (tok.type == TokenType::EQUAL) {
        ...
        self->addChild(std::move(assignment_node));
        ...
        self->addChild(std::move(assign_multiply_result_node));
        ...
        self->addChild(std::move(assign_divide_result_node));
        ...
        self->addChild(std::move(assign_modulus_result_node));
        ...
        self->addChild(std::move(assign_addition_result_node));
        ...
        self->addChild(std::move(assign_subtraction_result_node));
        ...
        self->addChild(std::move(assign_left_shift_result_node));
        ...
        self->addChild(std::move(assign_right_shift_result_node));
        ...
        self->addChild(std::move(assign_bitwise_and_result_node));
        ...
        self->addChild(std::move(assign_xor_result_node));
        ...
        self->addChild(std::move(assign_bitwise_or_result_node));
...
std::unique_ptr<Node> Parser::unary_operator()
{
    ...
    if (tok.type == TokenType::AND) {
        ...
        self->addChild(std::move(unary_and_node));
        ...
        self->addChild(std::move(pointer_op_node));
        ...
        self->addChild(std::move(unary_positive_node);
        ...
        self->addChild(std::move(unary_negative_node));
        ...
        self->addChild(std::move(bitwise_not_node));
        ...
        self->addChild(std::move(unary_not_node));
    } else {
        std::unique_ptr<Node> error_node = std::make_unique<Node>();
        error_node->type = Type::ERROR;
        error_node->data = tok.value;
...
std::unique_ptr<Node> Parser::jump_statement()
{
    ...
    if (tok.type == TokenType::GOTO) {
        ...
        self->addChild(std::move(goto_node));
        ...
        if (tok.type == TokenType::ID) {
            ...
            self->addChild(std::move(goto_label));
        } else {
            self->accepted = false;
        }
        ...
        self->addChild(std::move(continue_node));
        ...
        self->addChild(std::move(break_node));
    } else {
        std::unique_ptr<Node> error_node = std::make_unique<Node>();
        error_node->type = Type::ERROR;
        error_node->data = tok.value;
    ...
    if (tok.type == TokenType::SEMICOLON) {
        ...
        self->addChild(std::move(semicolon_node));
    } else {
        self->accepted = false;
    }
